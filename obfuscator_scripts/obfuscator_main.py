...
class Obfuscation:
    ...
    def randManifest_obfuscate(self, xml_file):
        # call Manifest class
        self.xml_file = xml_file
        print('Running Random Manifest obfuscator')
        try:
            randManifest.obfuscate(xml_file)
        
        except Exception as e:
            print(
                'Error during execution of randManifest_obfuscate: {0}'.format(e)
            )
            raise
